    ...
    public partial class CreateSeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "john.doe@example.com", "I would like to inquire about booking a sedan for a weekend trip. Please let me know the availability and pricing details.", "John Doe", new DateTime(2025, 3, 9, 18, 3, 9, 347, DateTimeKind.Local).AddTicks(1775), "Booking Inquiry - Sedan" },
                    { 2, "jane.smith@example.com", "I'm interested in renting an SUV for a family vacation next month. Could you provide information on availability and the rental terms?", "Jane Smith", new DateTime(2025, 3, 9, 18, 3, 9, 347, DateTimeKind.Local).AddTicks(2265), "Car Rental Request - SUV" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 2, "The history of cars is a long and interesting one. It all started with the invention of the wheel, and has evolved into the modern vehicles we see on the road today.", "https://images.nationalgeographic.org/image/upload/t_edhub_resource_key_image/v1638892232/EducationHub/photos/packard-model-b-automobile.jpg", new DateTime(2025, 3, 9, 18, 3, 9, 318, DateTimeKind.Local).AddTicks(3339), "The history of cars is a long and interesting one.", "Car History" },
                    { 2, 2, 1, "Formula 1 is a dangerous sport, and accidents are a common occurrence. However, some accidents are more serious than others, and can have a lasting impact on the drivers involved.", "https://i.dunya.com/storage/files/images/2023/03/02/formula-1-YPIe_cover.jpg", new DateTime(2025, 3, 9, 18, 3, 9, 318, DateTimeKind.Local).AddTicks(7239), "Formula 1 is a dangerous sport, and accidents are a common occurrence.", "Formula 1 Accident" },
                    { 3, 1, 2, "Electric vehicles (EVs) have come a long way from their early prototypes to the modern, high-performance machines we see today. Advances in battery technology, charging infrastructure, and sustainability efforts have made EVs a practical choice for consumers worldwide.", "https://www.currencytransfer.com/wp-content/uploads/2022/11/ev-2-edit.min_.jpg", new DateTime(2025, 3, 9, 18, 3, 9, 318, DateTimeKind.Local).AddTicks(7588), "A look at how electric cars have evolved and their impact on the automotive industry.", "The Evolution of Electric Cars" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "The history of cars is fascinating! It's amazing to see how far we've come in such a short time. I’m curious about the future developments in car technology.", new DateTime(2025, 3, 9, 18, 3, 9, 311, DateTimeKind.Local).AddTicks(297), "johndoe@email.com", "John Doe" },
                    { 2, 2, "Formula 1 accidents are terrifying. The risks drivers face are unimaginable, and it's always shocking to see how they walk away from such crashes.", new DateTime(2025, 3, 9, 18, 3, 9, 316, DateTimeKind.Local).AddTicks(9467), "janesmith@email.com", "Jane Smith" },
                    { 3, 3, "Electric cars are definitely the future. The advancements in battery technology make them more practical than ever. It's great to see the industry moving towards sustainability.", new DateTime(2025, 3, 9, 18, 3, 9, 316, DateTimeKind.Local).AddTicks(9494), "carlosrivera@email.com", "Carlos Rivera" },
                    { 4, 3, "The development of electric vehicles is impressive. It’s exciting to think about the impact these cars will have on the environment and the way we drive.", new DateTime(2025, 3, 9, 18, 3, 9, 316, DateTimeKind.Local).AddTicks(9496), "sarahlee@email.com", "Sarah Lee" },
                    { 5, 2, "Formula 1 accidents may be common, but they always leave a lasting impression. Every time something happens, it makes you appreciate the skill and bravery of the drivers even more.", new DateTime(2025, 3, 9, 18, 3, 9, 316, DateTimeKind.Local).AddTicks(9498), "mikejohnson@email.com", "Mike Johnson" },
                    { 6, 3, "I’ve always been fascinated by how electric vehicles have evolved. The shift from fossil fuels to electricity is one of the most important movements in the auto industry.", new DateTime(2025, 3, 9, 18, 3, 9, 316, DateTimeKind.Local).AddTicks(9499), "emilygreen@email.com", "Emily Green" }
                });
