...
namespace CarBook.WebApi.Controllers
{
    ...
    public class ModelsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll([FromQuery] GetModelsQuery getModelsQuery)
        {
            ...
            return Ok(GenericApiResponse<IEnumerable<GetModelsDto>>.Success(modelsDto));
        }

        [HttpGet("{id}")]
        [ServiceFilter(typeof(NotFoundFilterAttribute<Model>))]
        public async Task<IActionResult> GetById(int id)
        {
            ...
            return Ok(GenericApiResponse<GetModelByIdDto>.Success(modelDto));
        }
